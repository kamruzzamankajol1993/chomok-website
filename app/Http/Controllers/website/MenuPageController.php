...
class MenuPageController extends Controller
{
    public function index(Request $request): View|JsonResponse
    {
        ...
        $query = MenuItem::query()
            ...
            ->with(['category', 'prices.variationAddons', 'mainImage', 'addons' => fn ($q) => $q->where('is_active', true)]);
    ...
    public function show(MenuItem $menuItem): View
    {
        ...
        $menuItem->load(['category', 'subcategory', 'prices.variationAddons', 'images', 'addons' => fn ($q) => $q->where('is_active', true)]);
    ...
    public function configuration(MenuItem $menuItem): JsonResponse
    {
        ...
        return response()->json([
            ...
            'has_addons' => $menuItem->addons->isNotEmpty() || $menuItem->prices->contains(fn ($price) => $price->variationAddons->isNotEmpty()),
        ]);
    }
}
