<div class="side-fab-stack">
  ...
  @if(Route::is('client.dashboard'))
    <button type="button" class="fab-btn login-fab-btn" data-bs-toggle="offcanvas" data-bs-target="#dashboardNavOffcanvas" aria-controls="dashboardNavOffcanvas" aria-label="Open dashboard menu">
  ...
  <a href="{{ $whatsappUrl ?: route('contact.index') }}" class="fab-btn whatsapp-fab-btn" @if($whatsappUrl) target="_blank" rel="noopener" @endif aria-label="{{ $whatsappUrl ? 'Chat on WhatsApp at '.($siteSetting?->phone ?? '') : 'Contact us' }}" title="{{ $whatsappUrl ? 'WhatsApp: '.($siteSetting?->phone ?? '') : 'Contact us' }}">
  ...
  <button type="button" class="fab-btn category-fab-btn" data-bs-toggle="offcanvas" data-bs-target="#categoryOffcanvas" aria-controls="categoryOffcanvas" aria-label="Filter by category"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="3" y="3" width="7" height="7"></rect><rect x="14" y="3" width="7" height="7"></rect><rect x="14" y="14" width="7" height="7"></rect><rect x="3" y="14" width="7" height="7"></rect></svg></button>
